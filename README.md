...
```javascript
map = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-map@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-map@umd/bundle.js"></script>
```
...
[@stdlib/ndarray/base/unary]: https://github.com/stdlib-js/stdlib/tree/umd
